...
-- Removed MyGame from Types.hs
-- Can these functions be changed so that they take a type variable that is State or Monad?
-- Or change so that it doesn't need to return the game state?
